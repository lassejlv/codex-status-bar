...
- Replaced Claude artwork and animation choices with the supplied Codex mark and subtle motion.
- Removed transcript parsing, upstream release checks, and external runtime dependencies.
